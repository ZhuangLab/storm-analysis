...
datareader.py - For reading various kinds of STORM movie data. Currently
   this is limited to the Zhuang lab .dax format file.
...
grid - C functions for histogramming data in 2D and 3D.
