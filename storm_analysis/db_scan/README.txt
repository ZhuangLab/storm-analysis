...
molecule_clusters_size_list.bin - Same as above, but in addition the cluster size is stored in the "a" field
...
(2) To change the DBSCAN parameters (epsilon, minimum counts and minimum cluster size) you need to edit the
    dbscan_analysis.py file.
