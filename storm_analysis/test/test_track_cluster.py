...
def test_track_average_correct():
    ...
    settings = storm_analysis.get_data("test/data/test_drift.xml")
    alist_name = storm_analysis.get_path_output_test("test_drift_alist.bin")
...
def test_dbscan():
    ...
    clist_name = storm_analysis.get_path_output_test("test_drift_aclusters_size_list.bin")
    image_name = storm_analysis.get_path_output_test("test_drift_db")
...
def test_voronoi():
    ...
    alist_name = storm_analysis.get_path_output_test("test_drift_alist.bin")
    output_dir = storm_analysis.get_path_output_test("./")

    from storm_analysis.voronoi.voronoi_analysis import voronoiAnalysis
    voronoiAnalysis(alist_name, 1.25, output_dir)

    clist_name = storm_analysis.get_path_output_test("test_drift_asrt_size_list.bin")
    image_name = storm_analysis.get_path_output_test("test_drift_vr")
