...
def testingParameters():
    """
    Create a Spliner parameters object for ADMM deconvolution. Currently
    ADMM and FISTA use the same parameters.
    """
    ...
    params.setAttr("fista_iterations", "int", 50)
    params.setAttr("fista_lambda", "float", 20.0)
    params.setAttr("fista_number_z", "int", 1)
    params.setAttr("fista_threshold", "float", 500.0)
    params.setAttr("fista_timestep", "float", 0.01)
