%
% Demo script for deconSTORM, using example fluorescence data from imaging microtubules.
%
...
load('deconSTORM_microtubuledata.mat','mov')
...
fileout = 'deconSTORM_simarrow_results.mat';
