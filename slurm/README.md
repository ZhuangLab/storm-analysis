...
2. run slurm/split_analysis.xml to create the necessary analysis.xml files.
...
9. perform the rest of the analysis pipeline on the merged file with storm_analysis/sa_utilities/track_average_correct.py
